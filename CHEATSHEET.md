Use an emoji by putting the slug in colons (`:slug:`) or tildes (`~slug~`).
...
| 👊 | `oncoming_fist`, `fist_oncoming`, `facepunch`, `punch` | Oncoming fist |
...
| 🙍🏼 | `medium_light_person_frowning`, `medium_light_frowning_person` | Medium light person frowning |
...
| 🙅🏽 | `medium_person_gesturing_no`, `medium_no_good` | Medium person gesturing no |
...
| 💁🏾 | `medium_dark_person_tipping_hand`, `medium_dark_tipping_hand_person`, `medium_dark_information_desk_person` | Medium dark person tipping hand |
...
| 👮🏽‍♂️ | `medium_man_police_officer`, `medium_policeman` | Medium man police officer |
| 👮🏾‍♂️ | `medium_dark_man_police_officer`, `medium_dark_policeman` | Medium dark man police officer |
| 👮🏿‍♂️ | `dark_man_police_officer`, `dark_policeman` | Dark man police officer |
| 👮‍♀️ | `woman_police_officer`, `policewoman` | Woman police officer |
| 👮🏻‍♀️ | `light_woman_police_officer`, `light_policewoman` | Light woman police officer |
| 👮🏼‍♀️ | `medium_light_woman_police_officer`, `medium_light_policewoman` | Medium light woman police officer |
...
| 🕵️🏽‍♂️ | `medium_man_detective`, `medium_male_detective` | Medium man detective |
| 🕵️🏾‍♂️ | `medium_dark_man_detective`, `medium_dark_male_detective` | Medium dark man detective |
| 🕵️🏿‍♂️ | `dark_man_detective`, `dark_male_detective` | Dark man detective |
| 🕵️‍♀️ | `woman_detective`, `female_detective` | Woman detective |
| 🕵️🏻‍♀️ | `light_woman_detective`, `light_female_detective` | Light woman detective |
| 🕵️🏼‍♀️ | `medium_light_woman_detective`, `medium_light_female_detective` | Medium light woman detective |
...
| 💂🏽‍♂️ | `medium_man_guard`, `medium_guardsman` | Medium man guard |
| 💂🏾‍♂️ | `medium_dark_man_guard`, `medium_dark_guardsman` | Medium dark man guard |
| 💂🏿‍♂️ | `dark_man_guard`, `dark_guardsman` | Dark man guard |
| 💂‍♀️ | `woman_guard`, `guardswoman` | Woman guard |
| 💂🏻‍♀️ | `light_woman_guard`, `light_guardswoman` | Light woman guard |
| 💂🏼‍♀️ | `medium_light_woman_guard`, `medium_light_guardswoman` | Medium light woman guard |
...
| 👷🏽‍♂️ | `medium_man_construction_worker`, `medium_construction_worker_man` | Medium man construction worker |
| 👷🏾‍♂️ | `medium_dark_man_construction_worker`, `medium_dark_construction_worker_man` | Medium dark man construction worker |
| 👷🏿‍♂️ | `dark_man_construction_worker`, `dark_construction_worker_man` | Dark man construction worker |
| 👷‍♀️ | `woman_construction_worker`, `construction_worker_woman` | Woman construction worker |
| 👷🏻‍♀️ | `light_woman_construction_worker`, `light_construction_worker_woman` | Light woman construction worker |
| 👷🏼‍♀️ | `medium_light_woman_construction_worker`, `medium_light_construction_worker_woman` | Medium light woman construction worker |
| 👷🏽‍♀️ | `medium_woman_construction_worker`, `medium_construction_worker_woman` | Medium woman construction worker |
| 👷🏾‍♀️ | `medium_dark_woman_construction_worker`, `medium_dark_construction_worker_woman` | Medium dark woman construction worker |
| 👷🏿‍♀️ | `dark_woman_construction_worker`, `dark_construction_worker_woman` | Dark woman construction worker |
| 🫅 | `person_with_crown` | Person with crown |
| 🫅🏻 | `light_person_with_crown` | Light person with crown |
| 🫅🏼 | `medium_light_person_with_crown` | Medium light person with crown |
...
| 👳🏽 | `medium_person_wearing_turban`, `medium_person_with_turban` | Medium person wearing turban |
| 👳🏾 | `medium_dark_person_wearing_turban`, `medium_dark_person_with_turban` | Medium dark person wearing turban |
| 👳🏿 | `dark_person_wearing_turban`, `dark_person_with_turban` | Dark person wearing turban |
| 👳‍♂️ | `man_wearing_turban`, `man_with_turban` | Man wearing turban |
| 👳🏻‍♂️ | `light_man_wearing_turban`, `light_man_with_turban` | Light man wearing turban |
| 👳🏼‍♂️ | `medium_light_man_wearing_turban`, `medium_light_man_with_turban` | Medium light man wearing turban |
| 👳🏽‍♂️ | `medium_man_wearing_turban`, `medium_man_with_turban` | Medium man wearing turban |
| 👳🏾‍♂️ | `medium_dark_man_wearing_turban`, `medium_dark_man_with_turban` | Medium dark man wearing turban |
| 👳🏿‍♂️ | `dark_man_wearing_turban`, `dark_man_with_turban` | Dark man wearing turban |
| 👳‍♀️ | `woman_wearing_turban`, `woman_with_turban` | Woman wearing turban |
| 👳🏻‍♀️ | `light_woman_wearing_turban`, `light_woman_with_turban` | Light woman wearing turban |
| 👳🏼‍♀️ | `medium_light_woman_wearing_turban`, `medium_light_woman_with_turban` | Medium light woman wearing turban |
| 👳🏽‍♀️ | `medium_woman_wearing_turban`, `medium_woman_with_turban` | Medium woman wearing turban |
| 👳🏾‍♀️ | `medium_dark_woman_wearing_turban`, `medium_dark_woman_with_turban` | Medium dark woman wearing turban |
| 👳🏿‍♀️ | `dark_woman_wearing_turban`, `dark_woman_with_turban` | Dark woman wearing turban |
| 👲 | `person_with_skullcap`, `man_with_gua_pi_mao` | Person with skullcap |
| 👲🏻 | `light_person_with_skullcap`, `light_man_with_gua_pi_mao` | Light person with skullcap |
| 👲🏼 | `medium_light_person_with_skullcap`, `medium_light_man_with_gua_pi_mao` | Medium light person with skullcap |
...
| 🫃🏽 | `medium_pregnant_man` | Medium pregnant man |
| 🫃🏾 | `medium_dark_pregnant_man` | Medium dark pregnant man |
| 🫃🏿 | `dark_pregnant_man` | Dark pregnant man |
| 🫄 | `pregnant_person` | Pregnant person |
| 🫄🏻 | `light_pregnant_person` | Light pregnant person |
| 🫄🏼 | `medium_light_pregnant_person` | Medium light pregnant person |
...
| 👼🏽 | `medium_baby_angel`, `medium_angel` | Medium baby angel |
| 👼🏾 | `medium_dark_baby_angel`, `medium_dark_angel` | Medium dark baby angel |
| 👼🏿 | `dark_baby_angel`, `dark_angel` | Dark baby angel |
| 🎅 | `santa_claus`, `santa` | Santa claus |
| 🎅🏻 | `light_santa_claus`, `light_santa` | Light santa claus |
| 🎅🏼 | `medium_light_santa_claus`, `medium_light_santa` | Medium light santa claus |
...
| 🦸🏽‍♂️ | `medium_man_superhero`, `medium_superhero_man` | Medium man superhero |
| 🦸🏾‍♂️ | `medium_dark_man_superhero`, `medium_dark_superhero_man` | Medium dark man superhero |
| 🦸🏿‍♂️ | `dark_man_superhero`, `dark_superhero_man` | Dark man superhero |
| 🦸‍♀️ | `woman_superhero`, `superhero_woman` | Woman superhero |
| 🦸🏻‍♀️ | `light_woman_superhero`, `light_superhero_woman` | Light woman superhero |
| 🦸🏼‍♀️ | `medium_light_woman_superhero`, `medium_light_superhero_woman` | Medium light woman superhero |
...
| 🦹🏽‍♂️ | `medium_man_supervillain`, `medium_supervillain_man` | Medium man supervillain |
| 🦹🏾‍♂️ | `medium_dark_man_supervillain`, `medium_dark_supervillain_man` | Medium dark man supervillain |
| 🦹🏿‍♂️ | `dark_man_supervillain`, `dark_supervillain_man` | Dark man supervillain |
| 🦹‍♀️ | `woman_supervillain`, `supervillain_woman` | Woman supervillain |
| 🦹🏻‍♀️ | `light_woman_supervillain`, `light_supervillain_woman` | Light woman supervillain |
| 🦹🏼‍♀️ | `medium_light_woman_supervillain`, `medium_light_supervillain_woman` | Medium light woman supervillain |
...
| 🧙🏽‍♂️ | `medium_man_mage`, `medium_mage_man` | Medium man mage |
| 🧙🏾‍♂️ | `medium_dark_man_mage`, `medium_dark_mage_man` | Medium dark man mage |
| 🧙🏿‍♂️ | `dark_man_mage`, `dark_mage_man` | Dark man mage |
| 🧙‍♀️ | `woman_mage`, `mage_woman` | Woman mage |
| 🧙🏻‍♀️ | `light_woman_mage`, `light_mage_woman` | Light woman mage |
| 🧙🏼‍♀️ | `medium_light_woman_mage`, `medium_light_mage_woman` | Medium light woman mage |
...
| 🧚🏽‍♂️ | `medium_man_fairy`, `medium_fairy_man` | Medium man fairy |
| 🧚🏾‍♂️ | `medium_dark_man_fairy`, `medium_dark_fairy_man` | Medium dark man fairy |
| 🧚🏿‍♂️ | `dark_man_fairy`, `dark_fairy_man` | Dark man fairy |
| 🧚‍♀️ | `woman_fairy`, `fairy_woman` | Woman fairy |
| 🧚🏻‍♀️ | `light_woman_fairy`, `light_fairy_woman` | Light woman fairy |
| 🧚🏼‍♀️ | `medium_light_woman_fairy`, `medium_light_fairy_woman` | Medium light woman fairy |
...
| 🧛🏽‍♂️ | `medium_man_vampire`, `medium_vampire_man` | Medium man vampire |
| 🧛🏾‍♂️ | `medium_dark_man_vampire`, `medium_dark_vampire_man` | Medium dark man vampire |
| 🧛🏿‍♂️ | `dark_man_vampire`, `dark_vampire_man` | Dark man vampire |
| 🧛‍♀️ | `woman_vampire`, `vampire_woman` | Woman vampire |
| 🧛🏻‍♀️ | `light_woman_vampire`, `light_vampire_woman` | Light woman vampire |
| 🧛🏼‍♀️ | `medium_light_woman_vampire`, `medium_light_vampire_woman` | Medium light woman vampire |
...
| 🧝🏽‍♂️ | `medium_man_elf`, `medium_elf_man` | Medium man elf |
| 🧝🏾‍♂️ | `medium_dark_man_elf`, `medium_dark_elf_man` | Medium dark man elf |
| 🧝🏿‍♂️ | `dark_man_elf`, `dark_elf_man` | Dark man elf |
| 🧝‍♀️ | `woman_elf`, `elf_woman` | Woman elf |
| 🧝🏻‍♀️ | `light_woman_elf`, `light_elf_woman` | Light woman elf |
| 🧝🏼‍♀️ | `medium_light_woman_elf`, `medium_light_elf_woman` | Medium light woman elf |
...
| 🧌 | `troll` | Troll |
| 💆 | `person_getting_massage`, `massage` | Person getting massage |
| 💆🏻 | `light_person_getting_massage`, `light_massage` | Light person getting massage |
| 💆🏼 | `medium_light_person_getting_massage`, `medium_light_massage` | Medium light person getting massage |
| 💆🏽 | `medium_person_getting_massage`, `medium_massage` | Medium person getting massage |
| 💆🏾 | `medium_dark_person_getting_massage`, `medium_dark_massage` | Medium dark person getting massage |
| 💆🏿 | `dark_person_getting_massage`, `dark_massage` | Dark person getting massage |
| 💆‍♂️ | `man_getting_massage`, `massage_man` | Man getting massage |
| 💆🏻‍♂️ | `light_man_getting_massage`, `light_massage_man` | Light man getting massage |
| 💆🏼‍♂️ | `medium_light_man_getting_massage`, `medium_light_massage_man` | Medium light man getting massage |
| 💆🏽‍♂️ | `medium_man_getting_massage`, `medium_massage_man` | Medium man getting massage |
| 💆🏾‍♂️ | `medium_dark_man_getting_massage`, `medium_dark_massage_man` | Medium dark man getting massage |
| 💆🏿‍♂️ | `dark_man_getting_massage`, `dark_massage_man` | Dark man getting massage |
| 💆‍♀️ | `woman_getting_massage`, `massage_woman` | Woman getting massage |
| 💆🏻‍♀️ | `light_woman_getting_massage`, `light_massage_woman` | Light woman getting massage |
| 💆🏼‍♀️ | `medium_light_woman_getting_massage`, `medium_light_massage_woman` | Medium light woman getting massage |
| 💆🏽‍♀️ | `medium_woman_getting_massage`, `medium_massage_woman` | Medium woman getting massage |
| 💆🏾‍♀️ | `medium_dark_woman_getting_massage`, `medium_dark_massage_woman` | Medium dark woman getting massage |
| 💆🏿‍♀️ | `dark_woman_getting_massage`, `dark_massage_woman` | Dark woman getting massage |
| 💇 | `person_getting_haircut`, `haircut` | Person getting haircut |
| 💇🏻 | `light_person_getting_haircut`, `light_haircut` | Light person getting haircut |
| 💇🏼 | `medium_light_person_getting_haircut`, `medium_light_haircut` | Medium light person getting haircut |
| 💇🏽 | `medium_person_getting_haircut`, `medium_haircut` | Medium person getting haircut |
| 💇🏾 | `medium_dark_person_getting_haircut`, `medium_dark_haircut` | Medium dark person getting haircut |
| 💇🏿 | `dark_person_getting_haircut`, `dark_haircut` | Dark person getting haircut |
| 💇‍♂️ | `man_getting_haircut`, `haircut_man` | Man getting haircut |
| 💇🏻‍♂️ | `light_man_getting_haircut`, `light_haircut_man` | Light man getting haircut |
| 💇🏼‍♂️ | `medium_light_man_getting_haircut`, `medium_light_haircut_man` | Medium light man getting haircut |
| 💇🏽‍♂️ | `medium_man_getting_haircut`, `medium_haircut_man` | Medium man getting haircut |
| 💇🏾‍♂️ | `medium_dark_man_getting_haircut`, `medium_dark_haircut_man` | Medium dark man getting haircut |
| 💇🏿‍♂️ | `dark_man_getting_haircut`, `dark_haircut_man` | Dark man getting haircut |
| 💇‍♀️ | `woman_getting_haircut`, `haircut_woman` | Woman getting haircut |
| 💇🏻‍♀️ | `light_woman_getting_haircut`, `light_haircut_woman` | Light woman getting haircut |
| 💇🏼‍♀️ | `medium_light_woman_getting_haircut`, `medium_light_haircut_woman` | Medium light woman getting haircut |
| 💇🏽‍♀️ | `medium_woman_getting_haircut`, `medium_haircut_woman` | Medium woman getting haircut |
| 💇🏾‍♀️ | `medium_dark_woman_getting_haircut`, `medium_dark_haircut_woman` | Medium dark woman getting haircut |
| 💇🏿‍♀️ | `dark_woman_getting_haircut`, `dark_haircut_woman` | Dark woman getting haircut |
| 🚶 | `person_walking`, `walking` | Person walking |
| 🚶🏻 | `light_person_walking`, `light_walking` | Light person walking |
| 🚶🏼 | `medium_light_person_walking`, `medium_light_walking` | Medium light person walking |
| 🚶🏽 | `medium_person_walking`, `medium_walking` | Medium person walking |
| 🚶🏾 | `medium_dark_person_walking`, `medium_dark_walking` | Medium dark person walking |
| 🚶🏿 | `dark_person_walking`, `dark_walking` | Dark person walking |
| 🚶‍♂️ | `man_walking`, `walking_man` | Man walking |
| 🚶🏻‍♂️ | `light_man_walking`, `light_walking_man` | Light man walking |
| 🚶🏼‍♂️ | `medium_light_man_walking`, `medium_light_walking_man` | Medium light man walking |
| 🚶🏽‍♂️ | `medium_man_walking`, `medium_walking_man` | Medium man walking |
| 🚶🏾‍♂️ | `medium_dark_man_walking`, `medium_dark_walking_man` | Medium dark man walking |
| 🚶🏿‍♂️ | `dark_man_walking`, `dark_walking_man` | Dark man walking |
| 🚶‍♀️ | `woman_walking`, `walking_woman` | Woman walking |
| 🚶🏻‍♀️ | `light_woman_walking`, `light_walking_woman` | Light woman walking |
| 🚶🏼‍♀️ | `medium_light_woman_walking`, `medium_light_walking_woman` | Medium light woman walking |
| 🚶🏽‍♀️ | `medium_woman_walking`, `medium_walking_woman` | Medium woman walking |
| 🚶🏾‍♀️ | `medium_dark_woman_walking`, `medium_dark_walking_woman` | Medium dark woman walking |
| 🚶🏿‍♀️ | `dark_woman_walking`, `dark_walking_woman` | Dark woman walking |
| 🧍 | `person_standing`, `standing_person` | Person standing |
| 🧍🏻 | `light_person_standing`, `light_standing_person` | Light person standing |
| 🧍🏼 | `medium_light_person_standing`, `medium_light_standing_person` | Medium light person standing |
| 🧍🏽 | `medium_person_standing`, `medium_standing_person` | Medium person standing |
| 🧍🏾 | `medium_dark_person_standing`, `medium_dark_standing_person` | Medium dark person standing |
| 🧍🏿 | `dark_person_standing`, `dark_standing_person` | Dark person standing |
| 🧍‍♂️ | `man_standing`, `standing_man` | Man standing |
| 🧍🏻‍♂️ | `light_man_standing`, `light_standing_man` | Light man standing |
| 🧍🏼‍♂️ | `medium_light_man_standing`, `medium_light_standing_man` | Medium light man standing |
| 🧍🏽‍♂️ | `medium_man_standing`, `medium_standing_man` | Medium man standing |
| 🧍🏾‍♂️ | `medium_dark_man_standing`, `medium_dark_standing_man` | Medium dark man standing |
| 🧍🏿‍♂️ | `dark_man_standing`, `dark_standing_man` | Dark man standing |
| 🧍‍♀️ | `woman_standing`, `standing_woman` | Woman standing |
| 🧍🏻‍♀️ | `light_woman_standing`, `light_standing_woman` | Light woman standing |
| 🧍🏼‍♀️ | `medium_light_woman_standing`, `medium_light_standing_woman` | Medium light woman standing |
| 🧍🏽‍♀️ | `medium_woman_standing`, `medium_standing_woman` | Medium woman standing |
| 🧍🏾‍♀️ | `medium_dark_woman_standing`, `medium_dark_standing_woman` | Medium dark woman standing |
| 🧍🏿‍♀️ | `dark_woman_standing`, `dark_standing_woman` | Dark woman standing |
| 🧎 | `person_kneeling`, `kneeling_person` | Person kneeling |
| 🧎🏻 | `light_person_kneeling`, `light_kneeling_person` | Light person kneeling |
| 🧎🏼 | `medium_light_person_kneeling`, `medium_light_kneeling_person` | Medium light person kneeling |
| 🧎🏽 | `medium_person_kneeling`, `medium_kneeling_person` | Medium person kneeling |
| 🧎🏾 | `medium_dark_person_kneeling`, `medium_dark_kneeling_person` | Medium dark person kneeling |
| 🧎🏿 | `dark_person_kneeling`, `dark_kneeling_person` | Dark person kneeling |
| 🧎‍♂️ | `man_kneeling`, `kneeling_man` | Man kneeling |
| 🧎🏻‍♂️ | `light_man_kneeling`, `light_kneeling_man` | Light man kneeling |
| 🧎🏼‍♂️ | `medium_light_man_kneeling`, `medium_light_kneeling_man` | Medium light man kneeling |
| 🧎🏽‍♂️ | `medium_man_kneeling`, `medium_kneeling_man` | Medium man kneeling |
| 🧎🏾‍♂️ | `medium_dark_man_kneeling`, `medium_dark_kneeling_man` | Medium dark man kneeling |
| 🧎🏿‍♂️ | `dark_man_kneeling`, `dark_kneeling_man` | Dark man kneeling |
| 🧎‍♀️ | `woman_kneeling`, `kneeling_woman` | Woman kneeling |
| 🧎🏻‍♀️ | `light_woman_kneeling`, `light_kneeling_woman` | Light woman kneeling |
| 🧎🏼‍♀️ | `medium_light_woman_kneeling`, `medium_light_kneeling_woman` | Medium light woman kneeling |
| 🧎🏽‍♀️ | `medium_woman_kneeling`, `medium_kneeling_woman` | Medium woman kneeling |
| 🧎🏾‍♀️ | `medium_dark_woman_kneeling`, `medium_dark_kneeling_woman` | Medium dark woman kneeling |
| 🧎🏿‍♀️ | `dark_woman_kneeling`, `dark_kneeling_woman` | Dark woman kneeling |
| 🧑‍🦯 | `person_with_white_cane`, `person_with_probing_cane` | Person with white cane |
| 🧑🏻‍🦯 | `light_person_with_white_cane`, `light_person_with_probing_cane` | Light person with white cane |
| 🧑🏼‍🦯 | `medium_light_person_with_white_cane`, `medium_light_person_with_probing_cane` | Medium light person with white cane |
| 🧑🏽‍🦯 | `medium_person_with_white_cane`, `medium_person_with_probing_cane` | Medium person with white cane |
| 🧑🏾‍🦯 | `medium_dark_person_with_white_cane`, `medium_dark_person_with_probing_cane` | Medium dark person with white cane |
| 🧑🏿‍🦯 | `dark_person_with_white_cane`, `dark_person_with_probing_cane` | Dark person with white cane |
| 👨‍🦯 | `man_with_white_cane`, `man_with_probing_cane` | Man with white cane |
| 👨🏻‍🦯 | `light_man_with_white_cane`, `light_man_with_probing_cane` | Light man with white cane |
| 👨🏼‍🦯 | `medium_light_man_with_white_cane`, `medium_light_man_with_probing_cane` | Medium light man with white cane |
| 👨🏽‍🦯 | `medium_man_with_white_cane`, `medium_man_with_probing_cane` | Medium man with white cane |
| 👨🏾‍🦯 | `medium_dark_man_with_white_cane`, `medium_dark_man_with_probing_cane` | Medium dark man with white cane |
| 👨🏿‍🦯 | `dark_man_with_white_cane`, `dark_man_with_probing_cane` | Dark man with white cane |
| 👩‍🦯 | `woman_with_white_cane`, `woman_with_probing_cane` | Woman with white cane |
| 👩🏻‍🦯 | `light_woman_with_white_cane`, `light_woman_with_probing_cane` | Light woman with white cane |
| 👩🏼‍🦯 | `medium_light_woman_with_white_cane`, `medium_light_woman_with_probing_cane` | Medium light woman with white cane |
...
| 🏃🏽 | `medium_person_running`, `medium_runner`, `medium_running` | Medium person running |
| 🏃🏾 | `medium_dark_person_running`, `medium_dark_runner`, `medium_dark_running` | Medium dark person running |
| 🏃🏿 | `dark_person_running`, `dark_runner`, `dark_running` | Dark person running |
| 🏃‍♂️ | `man_running`, `running_man` | Man running |
| 🏃🏻‍♂️ | `light_man_running`, `light_running_man` | Light man running |
| 🏃🏼‍♂️ | `medium_light_man_running`, `medium_light_running_man` | Medium light man running |
| 🏃🏽‍♂️ | `medium_man_running`, `medium_running_man` | Medium man running |
| 🏃🏾‍♂️ | `medium_dark_man_running`, `medium_dark_running_man` | Medium dark man running |
| 🏃🏿‍♂️ | `dark_man_running`, `dark_running_man` | Dark man running |
| 🏃‍♀️ | `woman_running`, `running_woman` | Woman running |
| 🏃🏻‍♀️ | `light_woman_running`, `light_running_woman` | Light woman running |
| 🏃🏼‍♀️ | `medium_light_woman_running`, `medium_light_running_woman` | Medium light woman running |
...
| 🕴️🏽 | `medium_person_in_suit_levitating`, `medium_business_suit_levitating` | Medium person in suit levitating |
| 🕴️🏾 | `medium_dark_person_in_suit_levitating`, `medium_dark_business_suit_levitating` | Medium dark person in suit levitating |
| 🕴️🏿 | `dark_person_in_suit_levitating`, `dark_business_suit_levitating` | Dark person in suit levitating |
| 👯 | `people_with_bunny_ears`, `dancers` | People with bunny ears |
| 👯‍♂️ | `men_with_bunny_ears`, `dancing_men` | Men with bunny ears |
| 👯‍♀️ | `women_with_bunny_ears`, `dancing_women` | Women with bunny ears |
| 🧖 | `person_in_steamy_room`, `sauna_person` | Person in steamy room |
| 🧖🏻 | `light_person_in_steamy_room`, `light_sauna_person` | Light person in steamy room |
| 🧖🏼 | `medium_light_person_in_steamy_room`, `medium_light_sauna_person` | Medium light person in steamy room |
| 🧖🏽 | `medium_person_in_steamy_room`, `medium_sauna_person` | Medium person in steamy room |
| 🧖🏾 | `medium_dark_person_in_steamy_room`, `medium_dark_sauna_person` | Medium dark person in steamy room |
| 🧖🏿 | `dark_person_in_steamy_room`, `dark_sauna_person` | Dark person in steamy room |
| 🧖‍♂️ | `man_in_steamy_room`, `sauna_man` | Man in steamy room |
| 🧖🏻‍♂️ | `light_man_in_steamy_room`, `light_sauna_man` | Light man in steamy room |
| 🧖🏼‍♂️ | `medium_light_man_in_steamy_room`, `medium_light_sauna_man` | Medium light man in steamy room |
| 🧖🏽‍♂️ | `medium_man_in_steamy_room`, `medium_sauna_man` | Medium man in steamy room |
| 🧖🏾‍♂️ | `medium_dark_man_in_steamy_room`, `medium_dark_sauna_man` | Medium dark man in steamy room |
| 🧖🏿‍♂️ | `dark_man_in_steamy_room`, `dark_sauna_man` | Dark man in steamy room |
| 🧖‍♀️ | `woman_in_steamy_room`, `sauna_woman` | Woman in steamy room |
| 🧖🏻‍♀️ | `light_woman_in_steamy_room`, `light_sauna_woman` | Light woman in steamy room |
| 🧖🏼‍♀️ | `medium_light_woman_in_steamy_room`, `medium_light_sauna_woman` | Medium light woman in steamy room |
| 🧖🏽‍♀️ | `medium_woman_in_steamy_room`, `medium_sauna_woman` | Medium woman in steamy room |
| 🧖🏾‍♀️ | `medium_dark_woman_in_steamy_room`, `medium_dark_sauna_woman` | Medium dark woman in steamy room |
| 🧖🏿‍♀️ | `dark_woman_in_steamy_room`, `dark_sauna_woman` | Dark woman in steamy room |
| 🧗 | `person_climbing`, `climbing` | Person climbing |
| 🧗🏻 | `light_person_climbing`, `light_climbing` | Light person climbing |
| 🧗🏼 | `medium_light_person_climbing`, `medium_light_climbing` | Medium light person climbing |
| 🧗🏽 | `medium_person_climbing`, `medium_climbing` | Medium person climbing |
| 🧗🏾 | `medium_dark_person_climbing`, `medium_dark_climbing` | Medium dark person climbing |
| 🧗🏿 | `dark_person_climbing`, `dark_climbing` | Dark person climbing |
| 🧗‍♂️ | `man_climbing`, `climbing_man` | Man climbing |
| 🧗🏻‍♂️ | `light_man_climbing`, `light_climbing_man` | Light man climbing |
| 🧗🏼‍♂️ | `medium_light_man_climbing`, `medium_light_climbing_man` | Medium light man climbing |
| 🧗🏽‍♂️ | `medium_man_climbing`, `medium_climbing_man` | Medium man climbing |
| 🧗🏾‍♂️ | `medium_dark_man_climbing`, `medium_dark_climbing_man` | Medium dark man climbing |
| 🧗🏿‍♂️ | `dark_man_climbing`, `dark_climbing_man` | Dark man climbing |
| 🧗‍♀️ | `woman_climbing`, `climbing_woman` | Woman climbing |
| 🧗🏻‍♀️ | `light_woman_climbing`, `light_climbing_woman` | Light woman climbing |
| 🧗🏼‍♀️ | `medium_light_woman_climbing`, `medium_light_climbing_woman` | Medium light woman climbing |
...
| 🏌️🏽 | `medium_person_golfing`, `medium_golfing` | Medium person golfing |
| 🏌️🏾 | `medium_dark_person_golfing`, `medium_dark_golfing` | Medium dark person golfing |
| 🏌️🏿 | `dark_person_golfing`, `dark_golfing` | Dark person golfing |
| 🏌️‍♂️ | `man_golfing`, `golfing_man` | Man golfing |
| 🏌️🏻‍♂️ | `light_man_golfing`, `light_golfing_man` | Light man golfing |
| 🏌️🏼‍♂️ | `medium_light_man_golfing`, `medium_light_golfing_man` | Medium light man golfing |
| 🏌️🏽‍♂️ | `medium_man_golfing`, `medium_golfing_man` | Medium man golfing |
| 🏌️🏾‍♂️ | `medium_dark_man_golfing`, `medium_dark_golfing_man` | Medium dark man golfing |
| 🏌️🏿‍♂️ | `dark_man_golfing`, `dark_golfing_man` | Dark man golfing |
| 🏌️‍♀️ | `woman_golfing`, `golfing_woman` | Woman golfing |
| 🏌️🏻‍♀️ | `light_woman_golfing`, `light_golfing_woman` | Light woman golfing |
| 🏌️🏼‍♀️ | `medium_light_woman_golfing`, `medium_light_golfing_woman` | Medium light woman golfing |
| 🏌️🏽‍♀️ | `medium_woman_golfing`, `medium_golfing_woman` | Medium woman golfing |
| 🏌️🏾‍♀️ | `medium_dark_woman_golfing`, `medium_dark_golfing_woman` | Medium dark woman golfing |
| 🏌️🏿‍♀️ | `dark_woman_golfing`, `dark_golfing_woman` | Dark woman golfing |
| 🏄 | `person_surfing`, `surfer` | Person surfing |
| 🏄🏻 | `light_person_surfing`, `light_surfer` | Light person surfing |
| 🏄🏼 | `medium_light_person_surfing`, `medium_light_surfer` | Medium light person surfing |
| 🏄🏽 | `medium_person_surfing`, `medium_surfer` | Medium person surfing |
| 🏄🏾 | `medium_dark_person_surfing`, `medium_dark_surfer` | Medium dark person surfing |
| 🏄🏿 | `dark_person_surfing`, `dark_surfer` | Dark person surfing |
| 🏄‍♂️ | `man_surfing`, `surfing_man` | Man surfing |
| 🏄🏻‍♂️ | `light_man_surfing`, `light_surfing_man` | Light man surfing |
| 🏄🏼‍♂️ | `medium_light_man_surfing`, `medium_light_surfing_man` | Medium light man surfing |
| 🏄🏽‍♂️ | `medium_man_surfing`, `medium_surfing_man` | Medium man surfing |
| 🏄🏾‍♂️ | `medium_dark_man_surfing`, `medium_dark_surfing_man` | Medium dark man surfing |
| 🏄🏿‍♂️ | `dark_man_surfing`, `dark_surfing_man` | Dark man surfing |
| 🏄‍♀️ | `woman_surfing`, `surfing_woman` | Woman surfing |
| 🏄🏻‍♀️ | `light_woman_surfing`, `light_surfing_woman` | Light woman surfing |
| 🏄🏼‍♀️ | `medium_light_woman_surfing`, `medium_light_surfing_woman` | Medium light woman surfing |
| 🏄🏽‍♀️ | `medium_woman_surfing`, `medium_surfing_woman` | Medium woman surfing |
| 🏄🏾‍♀️ | `medium_dark_woman_surfing`, `medium_dark_surfing_woman` | Medium dark woman surfing |
| 🏄🏿‍♀️ | `dark_woman_surfing`, `dark_surfing_woman` | Dark woman surfing |
| 🚣 | `person_rowing_boat`, `rowboat` | Person rowing boat |
| 🚣🏻 | `light_person_rowing_boat`, `light_rowboat` | Light person rowing boat |
| 🚣🏼 | `medium_light_person_rowing_boat`, `medium_light_rowboat` | Medium light person rowing boat |
| 🚣🏽 | `medium_person_rowing_boat`, `medium_rowboat` | Medium person rowing boat |
| 🚣🏾 | `medium_dark_person_rowing_boat`, `medium_dark_rowboat` | Medium dark person rowing boat |
| 🚣🏿 | `dark_person_rowing_boat`, `dark_rowboat` | Dark person rowing boat |
| 🚣‍♂️ | `man_rowing_boat`, `rowing_man` | Man rowing boat |
| 🚣🏻‍♂️ | `light_man_rowing_boat`, `light_rowing_man` | Light man rowing boat |
| 🚣🏼‍♂️ | `medium_light_man_rowing_boat`, `medium_light_rowing_man` | Medium light man rowing boat |
| 🚣🏽‍♂️ | `medium_man_rowing_boat`, `medium_rowing_man` | Medium man rowing boat |
| 🚣🏾‍♂️ | `medium_dark_man_rowing_boat`, `medium_dark_rowing_man` | Medium dark man rowing boat |
| 🚣🏿‍♂️ | `dark_man_rowing_boat`, `dark_rowing_man` | Dark man rowing boat |
| 🚣‍♀️ | `woman_rowing_boat`, `rowing_woman` | Woman rowing boat |
| 🚣🏻‍♀️ | `light_woman_rowing_boat`, `light_rowing_woman` | Light woman rowing boat |
| 🚣🏼‍♀️ | `medium_light_woman_rowing_boat`, `medium_light_rowing_woman` | Medium light woman rowing boat |
| 🚣🏽‍♀️ | `medium_woman_rowing_boat`, `medium_rowing_woman` | Medium woman rowing boat |
| 🚣🏾‍♀️ | `medium_dark_woman_rowing_boat`, `medium_dark_rowing_woman` | Medium dark woman rowing boat |
| 🚣🏿‍♀️ | `dark_woman_rowing_boat`, `dark_rowing_woman` | Dark woman rowing boat |
| 🏊 | `person_swimming`, `swimmer` | Person swimming |
| 🏊🏻 | `light_person_swimming`, `light_swimmer` | Light person swimming |
| 🏊🏼 | `medium_light_person_swimming`, `medium_light_swimmer` | Medium light person swimming |
| 🏊🏽 | `medium_person_swimming`, `medium_swimmer` | Medium person swimming |
| 🏊🏾 | `medium_dark_person_swimming`, `medium_dark_swimmer` | Medium dark person swimming |
| 🏊🏿 | `dark_person_swimming`, `dark_swimmer` | Dark person swimming |
| 🏊‍♂️ | `man_swimming`, `swimming_man` | Man swimming |
| 🏊🏻‍♂️ | `light_man_swimming`, `light_swimming_man` | Light man swimming |
| 🏊🏼‍♂️ | `medium_light_man_swimming`, `medium_light_swimming_man` | Medium light man swimming |
| 🏊🏽‍♂️ | `medium_man_swimming`, `medium_swimming_man` | Medium man swimming |
| 🏊🏾‍♂️ | `medium_dark_man_swimming`, `medium_dark_swimming_man` | Medium dark man swimming |
| 🏊🏿‍♂️ | `dark_man_swimming`, `dark_swimming_man` | Dark man swimming |
| 🏊‍♀️ | `woman_swimming`, `swimming_woman` | Woman swimming |
| 🏊🏻‍♀️ | `light_woman_swimming`, `light_swimming_woman` | Light woman swimming |
| 🏊🏼‍♀️ | `medium_light_woman_swimming`, `medium_light_swimming_woman` | Medium light woman swimming |
| 🏊🏽‍♀️ | `medium_woman_swimming`, `medium_swimming_woman` | Medium woman swimming |
| 🏊🏾‍♀️ | `medium_dark_woman_swimming`, `medium_dark_swimming_woman` | Medium dark woman swimming |
| 🏊🏿‍♀️ | `dark_woman_swimming`, `dark_swimming_woman` | Dark woman swimming |
| ⛹️ | `person_bouncing_ball`, `bouncing_ball_person` | Person bouncing ball |
| ⛹️🏻 | `light_person_bouncing_ball`, `light_bouncing_ball_person` | Light person bouncing ball |
| ⛹️🏼 | `medium_light_person_bouncing_ball`, `medium_light_bouncing_ball_person` | Medium light person bouncing ball |
| ⛹️🏽 | `medium_person_bouncing_ball`, `medium_bouncing_ball_person` | Medium person bouncing ball |
| ⛹️🏾 | `medium_dark_person_bouncing_ball`, `medium_dark_bouncing_ball_person` | Medium dark person bouncing ball |
| ⛹️🏿 | `dark_person_bouncing_ball`, `dark_bouncing_ball_person` | Dark person bouncing ball |
| ⛹️‍♂️ | `man_bouncing_ball`, `bouncing_ball_man`, `basketball_man` | Man bouncing ball |
| ⛹️🏻‍♂️ | `light_man_bouncing_ball`, `light_bouncing_ball_man`, `light_basketball_man` | Light man bouncing ball |
| ⛹️🏼‍♂️ | `medium_light_man_bouncing_ball`, `medium_light_bouncing_ball_man`, `medium_light_basketball_man` | Medium light man bouncing ball |
| ⛹️🏽‍♂️ | `medium_man_bouncing_ball`, `medium_bouncing_ball_man`, `medium_basketball_man` | Medium man bouncing ball |
| ⛹️🏾‍♂️ | `medium_dark_man_bouncing_ball`, `medium_dark_bouncing_ball_man`, `medium_dark_basketball_man` | Medium dark man bouncing ball |
| ⛹️🏿‍♂️ | `dark_man_bouncing_ball`, `dark_bouncing_ball_man`, `dark_basketball_man` | Dark man bouncing ball |
| ⛹️‍♀️ | `woman_bouncing_ball`, `bouncing_ball_woman`, `basketball_woman` | Woman bouncing ball |
| ⛹️🏻‍♀️ | `light_woman_bouncing_ball`, `light_bouncing_ball_woman`, `light_basketball_woman` | Light woman bouncing ball |
| ⛹️🏼‍♀️ | `medium_light_woman_bouncing_ball`, `medium_light_bouncing_ball_woman`, `medium_light_basketball_woman` | Medium light woman bouncing ball |
| ⛹️🏽‍♀️ | `medium_woman_bouncing_ball`, `medium_bouncing_ball_woman`, `medium_basketball_woman` | Medium woman bouncing ball |
| ⛹️🏾‍♀️ | `medium_dark_woman_bouncing_ball`, `medium_dark_bouncing_ball_woman`, `medium_dark_basketball_woman` | Medium dark woman bouncing ball |
| ⛹️🏿‍♀️ | `dark_woman_bouncing_ball`, `dark_bouncing_ball_woman`, `dark_basketball_woman` | Dark woman bouncing ball |
| 🏋️ | `person_lifting_weights`, `weight_lifting` | Person lifting weights |
| 🏋️🏻 | `light_person_lifting_weights`, `light_weight_lifting` | Light person lifting weights |
| 🏋️🏼 | `medium_light_person_lifting_weights`, `medium_light_weight_lifting` | Medium light person lifting weights |
| 🏋️🏽 | `medium_person_lifting_weights`, `medium_weight_lifting` | Medium person lifting weights |
| 🏋️🏾 | `medium_dark_person_lifting_weights`, `medium_dark_weight_lifting` | Medium dark person lifting weights |
| 🏋️🏿 | `dark_person_lifting_weights`, `dark_weight_lifting` | Dark person lifting weights |
| 🏋️‍♂️ | `man_lifting_weights`, `weight_lifting_man` | Man lifting weights |
| 🏋️🏻‍♂️ | `light_man_lifting_weights`, `light_weight_lifting_man` | Light man lifting weights |
| 🏋️🏼‍♂️ | `medium_light_man_lifting_weights`, `medium_light_weight_lifting_man` | Medium light man lifting weights |
| 🏋️🏽‍♂️ | `medium_man_lifting_weights`, `medium_weight_lifting_man` | Medium man lifting weights |
| 🏋️🏾‍♂️ | `medium_dark_man_lifting_weights`, `medium_dark_weight_lifting_man` | Medium dark man lifting weights |
| 🏋️🏿‍♂️ | `dark_man_lifting_weights`, `dark_weight_lifting_man` | Dark man lifting weights |
| 🏋️‍♀️ | `woman_lifting_weights`, `weight_lifting_woman` | Woman lifting weights |
| 🏋️🏻‍♀️ | `light_woman_lifting_weights`, `light_weight_lifting_woman` | Light woman lifting weights |
| 🏋️🏼‍♀️ | `medium_light_woman_lifting_weights`, `medium_light_weight_lifting_woman` | Medium light woman lifting weights |
| 🏋️🏽‍♀️ | `medium_woman_lifting_weights`, `medium_weight_lifting_woman` | Medium woman lifting weights |
| 🏋️🏾‍♀️ | `medium_dark_woman_lifting_weights`, `medium_dark_weight_lifting_woman` | Medium dark woman lifting weights |
| 🏋️🏿‍♀️ | `dark_woman_lifting_weights`, `dark_weight_lifting_woman` | Dark woman lifting weights |
| 🚴 | `person_biking`, `bicyclist` | Person biking |
| 🚴🏻 | `light_person_biking`, `light_bicyclist` | Light person biking |
| 🚴🏼 | `medium_light_person_biking`, `medium_light_bicyclist` | Medium light person biking |
| 🚴🏽 | `medium_person_biking`, `medium_bicyclist` | Medium person biking |
| 🚴🏾 | `medium_dark_person_biking`, `medium_dark_bicyclist` | Medium dark person biking |
| 🚴🏿 | `dark_person_biking`, `dark_bicyclist` | Dark person biking |
| 🚴‍♂️ | `man_biking`, `biking_man` | Man biking |
| 🚴🏻‍♂️ | `light_man_biking`, `light_biking_man` | Light man biking |
| 🚴🏼‍♂️ | `medium_light_man_biking`, `medium_light_biking_man` | Medium light man biking |
| 🚴🏽‍♂️ | `medium_man_biking`, `medium_biking_man` | Medium man biking |
| 🚴🏾‍♂️ | `medium_dark_man_biking`, `medium_dark_biking_man` | Medium dark man biking |
| 🚴🏿‍♂️ | `dark_man_biking`, `dark_biking_man` | Dark man biking |
| 🚴‍♀️ | `woman_biking`, `biking_woman` | Woman biking |
| 🚴🏻‍♀️ | `light_woman_biking`, `light_biking_woman` | Light woman biking |
| 🚴🏼‍♀️ | `medium_light_woman_biking`, `medium_light_biking_woman` | Medium light woman biking |
| 🚴🏽‍♀️ | `medium_woman_biking`, `medium_biking_woman` | Medium woman biking |
| 🚴🏾‍♀️ | `medium_dark_woman_biking`, `medium_dark_biking_woman` | Medium dark woman biking |
| 🚴🏿‍♀️ | `dark_woman_biking`, `dark_biking_woman` | Dark woman biking |
| 🚵 | `person_mountain_biking`, `mountain_bicyclist` | Person mountain biking |
| 🚵🏻 | `light_person_mountain_biking`, `light_mountain_bicyclist` | Light person mountain biking |
| 🚵🏼 | `medium_light_person_mountain_biking`, `medium_light_mountain_bicyclist` | Medium light person mountain biking |
| 🚵🏽 | `medium_person_mountain_biking`, `medium_mountain_bicyclist` | Medium person mountain biking |
| 🚵🏾 | `medium_dark_person_mountain_biking`, `medium_dark_mountain_bicyclist` | Medium dark person mountain biking |
| 🚵🏿 | `dark_person_mountain_biking`, `dark_mountain_bicyclist` | Dark person mountain biking |
| 🚵‍♂️ | `man_mountain_biking`, `mountain_biking_man` | Man mountain biking |
| 🚵🏻‍♂️ | `light_man_mountain_biking`, `light_mountain_biking_man` | Light man mountain biking |
| 🚵🏼‍♂️ | `medium_light_man_mountain_biking`, `medium_light_mountain_biking_man` | Medium light man mountain biking |
| 🚵🏽‍♂️ | `medium_man_mountain_biking`, `medium_mountain_biking_man` | Medium man mountain biking |
| 🚵🏾‍♂️ | `medium_dark_man_mountain_biking`, `medium_dark_mountain_biking_man` | Medium dark man mountain biking |
| 🚵🏿‍♂️ | `dark_man_mountain_biking`, `dark_mountain_biking_man` | Dark man mountain biking |
| 🚵‍♀️ | `woman_mountain_biking`, `mountain_biking_woman` | Woman mountain biking |
| 🚵🏻‍♀️ | `light_woman_mountain_biking`, `light_mountain_biking_woman` | Light woman mountain biking |
| 🚵🏼‍♀️ | `medium_light_woman_mountain_biking`, `medium_light_mountain_biking_woman` | Medium light woman mountain biking |
| 🚵🏽‍♀️ | `medium_woman_mountain_biking`, `medium_mountain_biking_woman` | Medium woman mountain biking |
| 🚵🏾‍♀️ | `medium_dark_woman_mountain_biking`, `medium_dark_mountain_biking_woman` | Medium dark woman mountain biking |
| 🚵🏿‍♀️ | `dark_woman_mountain_biking`, `dark_mountain_biking_woman` | Dark woman mountain biking |
| 🤸 | `person_cartwheeling`, `cartwheeling` | Person cartwheeling |
| 🤸🏻 | `light_person_cartwheeling`, `light_cartwheeling` | Light person cartwheeling |
| 🤸🏼 | `medium_light_person_cartwheeling`, `medium_light_cartwheeling` | Medium light person cartwheeling |
...
| 🧘🏽 | `medium_person_in_lotus_position`, `medium_lotus_position` | Medium person in lotus position |
| 🧘🏾 | `medium_dark_person_in_lotus_position`, `medium_dark_lotus_position` | Medium dark person in lotus position |
| 🧘🏿 | `dark_person_in_lotus_position`, `dark_lotus_position` | Dark person in lotus position |
| 🧘‍♂️ | `man_in_lotus_position`, `lotus_position_man` | Man in lotus position |
| 🧘🏻‍♂️ | `light_man_in_lotus_position`, `light_lotus_position_man` | Light man in lotus position |
| 🧘🏼‍♂️ | `medium_light_man_in_lotus_position`, `medium_light_lotus_position_man` | Medium light man in lotus position |
| 🧘🏽‍♂️ | `medium_man_in_lotus_position`, `medium_lotus_position_man` | Medium man in lotus position |
| 🧘🏾‍♂️ | `medium_dark_man_in_lotus_position`, `medium_dark_lotus_position_man` | Medium dark man in lotus position |
| 🧘🏿‍♂️ | `dark_man_in_lotus_position`, `dark_lotus_position_man` | Dark man in lotus position |
| 🧘‍♀️ | `woman_in_lotus_position`, `lotus_position_woman` | Woman in lotus position |
| 🧘🏻‍♀️ | `light_woman_in_lotus_position`, `light_lotus_position_woman` | Light woman in lotus position |
| 🧘🏼‍♀️ | `medium_light_woman_in_lotus_position`, `medium_light_lotus_position_woman` | Medium light woman in lotus position |
| 🧘🏽‍♀️ | `medium_woman_in_lotus_position`, `medium_lotus_position_woman` | Medium woman in lotus position |
| 🧘🏾‍♀️ | `medium_dark_woman_in_lotus_position`, `medium_dark_lotus_position_woman` | Medium dark woman in lotus position |
| 🧘🏿‍♀️ | `dark_woman_in_lotus_position`, `dark_lotus_position_woman` | Dark woman in lotus position |
| 🛀 | `person_taking_bath`, `bath` | Person taking bath |
| 🛀🏻 | `light_person_taking_bath`, `light_bath` | Light person taking bath |
| 🛀🏼 | `medium_light_person_taking_bath`, `medium_light_bath` | Medium light person taking bath |
| 🛀🏽 | `medium_person_taking_bath`, `medium_bath` | Medium person taking bath |
| 🛀🏾 | `medium_dark_person_taking_bath`, `medium_dark_bath` | Medium dark person taking bath |
| 🛀🏿 | `dark_person_taking_bath`, `dark_bath` | Dark person taking bath |
| 🛌 | `person_in_bed`, `sleeping_bed` | Person in bed |
| 🛌🏻 | `light_person_in_bed`, `light_sleeping_bed` | Light person in bed |
| 🛌🏼 | `medium_light_person_in_bed`, `medium_light_sleeping_bed` | Medium light person in bed |
...
| 👭🏽 | `medium_women_holding_hands`, `medium_two_women_holding_hands` | Medium women holding hands |
| 👭🏾 | `medium_dark_women_holding_hands`, `medium_dark_two_women_holding_hands` | Medium dark women holding hands |
| 👭🏿 | `dark_women_holding_hands`, `dark_two_women_holding_hands` | Dark women holding hands |
| 👫 | `woman_and_man_holding_hands`, `couple` | Woman and man holding hands |
| 👫🏻 | `light_woman_and_man_holding_hands`, `light_couple` | Light woman and man holding hands |
| 👫🏼 | `medium_light_woman_and_man_holding_hands`, `medium_light_couple` | Medium light woman and man holding hands |
| 👫🏽 | `medium_woman_and_man_holding_hands`, `medium_couple` | Medium woman and man holding hands |
| 👫🏾 | `medium_dark_woman_and_man_holding_hands`, `medium_dark_couple` | Medium dark woman and man holding hands |
| 👫🏿 | `dark_woman_and_man_holding_hands`, `dark_couple` | Dark woman and man holding hands |
| 👬 | `men_holding_hands`, `two_men_holding_hands` | Men holding hands |
| 👬🏻 | `light_men_holding_hands`, `light_two_men_holding_hands` | Light men holding hands |
| 👬🏼 | `medium_light_men_holding_hands`, `medium_light_two_men_holding_hands` | Medium light men holding hands |
| 👬🏽 | `medium_men_holding_hands`, `medium_two_men_holding_hands` | Medium men holding hands |
| 👬🏾 | `medium_dark_men_holding_hands`, `medium_dark_two_men_holding_hands` | Medium dark men holding hands |
| 👬🏿 | `dark_men_holding_hands`, `dark_two_men_holding_hands` | Dark men holding hands |
| 💏 | `kiss`, `couplekiss` | Kiss |
| 💏🏻 | `light_kiss`, `light_couplekiss` | Light kiss |
| 💏🏼 | `medium_light_kiss`, `medium_light_couplekiss` | Medium light kiss |
| 💏🏽 | `medium_kiss`, `medium_couplekiss` | Medium kiss |
| 💏🏾 | `medium_dark_kiss`, `medium_dark_couplekiss` | Medium dark kiss |
| 💏🏿 | `dark_kiss`, `dark_couplekiss` | Dark kiss |
| 👩‍❤️‍💋‍👨 | `kiss_woman_man`, `couplekiss_man_woman` | Kiss woman, man |
| 👩🏻‍❤️‍💋‍👨 | `light_kiss_woman_man`, `light_couplekiss_man_woman` | Light kiss woman, man |
| 👩🏼‍❤️‍💋‍👨 | `medium_light_kiss_woman_man`, `medium_light_couplekiss_man_woman` | Medium light kiss woman, man |
| 👩🏽‍❤️‍💋‍👨 | `medium_kiss_woman_man`, `medium_couplekiss_man_woman` | Medium kiss woman, man |
| 👩🏾‍❤️‍💋‍👨 | `medium_dark_kiss_woman_man`, `medium_dark_couplekiss_man_woman` | Medium dark kiss woman, man |
| 👩🏿‍❤️‍💋‍👨 | `dark_kiss_woman_man`, `dark_couplekiss_man_woman` | Dark kiss woman, man |
| 👨‍❤️‍💋‍👨 | `kiss_man_man`, `couplekiss_man_man` | Kiss man, man |
| 👨🏻‍❤️‍💋‍👨 | `light_kiss_man_man`, `light_couplekiss_man_man` | Light kiss man, man |
| 👨🏼‍❤️‍💋‍👨 | `medium_light_kiss_man_man`, `medium_light_couplekiss_man_man` | Medium light kiss man, man |
| 👨🏽‍❤️‍💋‍👨 | `medium_kiss_man_man`, `medium_couplekiss_man_man` | Medium kiss man, man |
| 👨🏾‍❤️‍💋‍👨 | `medium_dark_kiss_man_man`, `medium_dark_couplekiss_man_man` | Medium dark kiss man, man |
| 👨🏿‍❤️‍💋‍👨 | `dark_kiss_man_man`, `dark_couplekiss_man_man` | Dark kiss man, man |
| 👩‍❤️‍💋‍👩 | `kiss_woman_woman`, `couplekiss_woman_woman` | Kiss woman, woman |
| 👩🏻‍❤️‍💋‍👩 | `light_kiss_woman_woman`, `light_couplekiss_woman_woman` | Light kiss woman, woman |
| 👩🏼‍❤️‍💋‍👩 | `medium_light_kiss_woman_woman`, `medium_light_couplekiss_woman_woman` | Medium light kiss woman, woman |
...
| 🕜 | `one_thirty`, `clock130` | One-thirty |
| 🕑 | `two_o_clock`, `clock2` | Two o’clock |
| 🕝 | `two_thirty`, `clock230` | Two-thirty |
| 🕒 | `three_o_clock`, `clock3` | Three o’clock |
| 🕞 | `three_thirty`, `clock330` | Three-thirty |
| 🕓 | `four_o_clock`, `clock4` | Four o’clock |
| 🕟 | `four_thirty`, `clock430` | Four-thirty |
| 🕔 | `five_o_clock`, `clock5` | Five o’clock |
| 🕠 | `five_thirty`, `clock530` | Five-thirty |
| 🕕 | `six_o_clock`, `clock6` | Six o’clock |
| 🕡 | `six_thirty`, `clock630` | Six-thirty |
| 🕖 | `seven_o_clock`, `clock7` | Seven o’clock |
| 🕢 | `seven_thirty`, `clock730` | Seven-thirty |
| 🕗 | `eight_o_clock`, `clock8` | Eight o’clock |
| 🕣 | `eight_thirty`, `clock830` | Eight-thirty |
| 🕘 | `nine_o_clock`, `clock9` | Nine o’clock |
| 🕤 | `nine_thirty`, `clock930` | Nine-thirty |
| 🕙 | `ten_o_clock`, `clock10` | Ten o’clock |
...
| ↘️ | `down_right_arrow`, `arrow_lower_right` | Down-right arrow |
| ⬇️ | `down_arrow`, `arrow_down` | Down arrow |
| ↙️ | `down_left_arrow`, `arrow_lower_left` | Down-left arrow |
...
| ⤵️ | `right_arrow_curving_down`, `arrow_heading_down` | Right arrow curving down |
| 🔃 | `clockwise_vertical_arrows`, `arrows_clockwise` | Clockwise vertical arrows |
| 🔄 | `counterclockwise_arrows_button`, `arrows_counterclockwise` | Counterclockwise arrows button |
| 🔙 | `back_arrow`, `back` | Back arrow |
| 🔚 | `end_arrow`, `end` | End arrow |
...
| 🔼 | `upwards_button`, `arrow_up_small` | Upwards button |
...
| ☑️ | `check_box_with_check`, `ballot_box_with_check` | Check box with check |
...
| 3️⃣ | `keycap_3`, `three` | Keycap 3 |
| 4️⃣ | `keycap_4`, `four` | Keycap 4 |
| 5️⃣ | `keycap_5`, `five` | Keycap 5 |
| 6️⃣ | `keycap_6`, `six` | Keycap 6 |
| 7️⃣ | `keycap_7`, `seven` | Keycap 7 |
| 8️⃣ | `keycap_8`, `eight` | Keycap 8 |
| 9️⃣ | `keycap_9`, `nine` | Keycap 9 |
| 🔟 | `keycap_10`, `keycap_ten` | Keycap 10 |
| 🔠 | `input_latin_uppercase`, `capital_abcd` | Input latin uppercase |
| 🔡 | `input_latin_lowercase`, `abcd` | Input latin lowercase |
| 🔢 | `input_numbers`, `1234` | Input numbers |
| 🔣 | `input_symbols`, `symbols` | Input symbols |
| 🔤 | `input_latin_letters`, `abc` | Input latin letters |
| 🅰️ | `a_button`, `a` | A button (blood type) |
| 🆎 | `ab_button`, `ab` | Ab button (blood type) |
| 🅱️ | `b_button`, `b` | B button (blood type) |
...
| 🆔 | `id_button`, `id` | Id button |
| Ⓜ️ | `circled_m`, `m` | Circled m |
| 🆕 | `new_button`, `new` | New button |
| 🆖 | `ng_button`, `ng` | Ng button |
| 🅾️ | `o_button`, `o2` | O button (blood type) |
| 🆗 | `ok_button`, `ok` | Ok button |
| 🅿️ | `p_button`, `parking` | P button |
| 🆘 | `sos_button`, `sos` | Sos button |
| 🆙 | `up_button`, `up` | Up! button |
| 🆚 | `vs_button`, `vs` | Vs button |
| 🈁 | `japanese_here_button`, `koko` | Japanese “here” button |
| 🈂️ | `japanese_service_charge_button`, `sa` | Japanese “service charge” button |
| 🈷️ | `japanese_monthly_amount_button`, `u6708` | Japanese “monthly amount” button |
| 🈶 | `japanese_not_free_of_charge_button`, `u6709` | Japanese “not free of charge” button |
| 🈯 | `japanese_reserved_button`, `u6307` | Japanese “reserved” button |
| 🉐 | `japanese_bargain_button`, `ideograph_advantage` | Japanese “bargain” button |
| 🈹 | `japanese_discount_button`, `u5272` | Japanese “discount” button |
| 🈚 | `japanese_free_of_charge_button`, `u7121` | Japanese “free of charge” button |
| 🈲 | `japanese_prohibited_button`, `u7981` | Japanese “prohibited” button |
| 🉑 | `japanese_acceptable_button`, `accept` | Japanese “acceptable” button |
| 🈸 | `japanese_application_button`, `u7533` | Japanese “application” button |
| 🈴 | `japanese_passing_grade_button`, `u5408` | Japanese “passing grade” button |
| 🈳 | `japanese_vacancy_button`, `u7a7a` | Japanese “vacancy” button |
| ㊗️ | `japanese_congratulations_button`, `congratulations` | Japanese “congratulations” button |
...
| 🇦🇫 | `flag_afghanistan`, `afghanistan` | Flag afghanistan |
| 🇦🇬 | `flag_antigua_barbuda`, `antigua_barbuda` | Flag antigua & barbuda |
| 🇦🇮 | `flag_anguilla`, `anguilla` | Flag anguilla |
| 🇦🇱 | `flag_albania`, `albania` | Flag albania |
| 🇦🇲 | `flag_armenia`, `armenia` | Flag armenia |
| 🇦🇴 | `flag_angola`, `angola` | Flag angola |
| 🇦🇶 | `flag_antarctica`, `antarctica` | Flag antarctica |
| 🇦🇷 | `flag_argentina`, `argentina` | Flag argentina |
| 🇦🇸 | `flag_american_samoa`, `american_samoa` | Flag american samoa |
| 🇦🇹 | `flag_austria`, `austria` | Flag austria |
| 🇦🇺 | `flag_australia`, `australia` | Flag australia |
| 🇦🇼 | `flag_aruba`, `aruba` | Flag aruba |
| 🇦🇽 | `flag_aland_islands`, `aland_islands` | Flag åland islands |
| 🇦🇿 | `flag_azerbaijan`, `azerbaijan` | Flag azerbaijan |
| 🇧🇦 | `flag_bosnia_herzegovina`, `bosnia_herzegovina` | Flag bosnia & herzegovina |
| 🇧🇧 | `flag_barbados`, `barbados` | Flag barbados |
| 🇧🇩 | `flag_bangladesh`, `bangladesh` | Flag bangladesh |
| 🇧🇪 | `flag_belgium`, `belgium` | Flag belgium |
| 🇧🇫 | `flag_burkina_faso`, `burkina_faso` | Flag burkina faso |
| 🇧🇬 | `flag_bulgaria`, `bulgaria` | Flag bulgaria |
| 🇧🇭 | `flag_bahrain`, `bahrain` | Flag bahrain |
| 🇧🇮 | `flag_burundi`, `burundi` | Flag burundi |
| 🇧🇯 | `flag_benin`, `benin` | Flag benin |
| 🇧🇱 | `flag_st_barthelemy`, `st_barthelemy` | Flag st. barthélemy |
| 🇧🇲 | `flag_bermuda`, `bermuda` | Flag bermuda |
| 🇧🇳 | `flag_brunei`, `brunei` | Flag brunei |
| 🇧🇴 | `flag_bolivia`, `bolivia` | Flag bolivia |
| 🇧🇶 | `flag_caribbean_netherlands`, `caribbean_netherlands` | Flag caribbean netherlands |
| 🇧🇷 | `flag_brazil`, `brazil` | Flag brazil |
| 🇧🇸 | `flag_bahamas`, `bahamas` | Flag bahamas |
| 🇧🇹 | `flag_bhutan`, `bhutan` | Flag bhutan |
| 🇧🇻 | `flag_bouvet_island`, `bouvet_island` | Flag bouvet island |
| 🇧🇼 | `flag_botswana`, `botswana` | Flag botswana |
| 🇧🇾 | `flag_belarus`, `belarus` | Flag belarus |
| 🇧🇿 | `flag_belize`, `belize` | Flag belize |
| 🇨🇦 | `flag_canada`, `canada` | Flag canada |
| 🇨🇨 | `flag_cocos_islands`, `cocos_islands` | Flag cocos (keeling) islands |
| 🇨🇩 | `flag_congo_kinshasa`, `congo_kinshasa` | Flag congo - kinshasa |
| 🇨🇫 | `flag_central_african_republic`, `central_african_republic` | Flag central african republic |
| 🇨🇬 | `flag_congo_brazzaville`, `congo_brazzaville` | Flag congo - brazzaville |
| 🇨🇭 | `flag_switzerland`, `switzerland` | Flag switzerland |
| 🇨🇮 | `flag_cote_d_ivoire`, `cote_divoire` | Flag côte d’ivoire |
| 🇨🇰 | `flag_cook_islands`, `cook_islands` | Flag cook islands |
| 🇨🇱 | `flag_chile`, `chile` | Flag chile |
| 🇨🇲 | `flag_cameroon`, `cameroon` | Flag cameroon |
| 🇨🇳 | `flag_china`, `cn` | Flag china |
| 🇨🇴 | `flag_colombia`, `colombia` | Flag colombia |
| 🇨🇵 | `flag_clipperton_island`, `clipperton_island` | Flag clipperton island |
| 🇨🇷 | `flag_costa_rica`, `costa_rica` | Flag costa rica |
| 🇨🇺 | `flag_cuba`, `cuba` | Flag cuba |
| 🇨🇻 | `flag_cape_verde`, `cape_verde` | Flag cape verde |
| 🇨🇼 | `flag_curacao`, `curacao` | Flag curaçao |
| 🇨🇽 | `flag_christmas_island`, `christmas_island` | Flag christmas island |
| 🇨🇾 | `flag_cyprus`, `cyprus` | Flag cyprus |
| 🇨🇿 | `flag_czechia`, `czech_republic` | Flag czechia |
| 🇩🇪 | `flag_germany`, `de` | Flag germany |
| 🇩🇬 | `flag_diego_garcia`, `diego_garcia` | Flag diego garcia |
| 🇩🇯 | `flag_djibouti`, `djibouti` | Flag djibouti |
| 🇩🇰 | `flag_denmark`, `denmark` | Flag denmark |
| 🇩🇲 | `flag_dominica`, `dominica` | Flag dominica |
| 🇩🇴 | `flag_dominican_republic`, `dominican_republic` | Flag dominican republic |
| 🇩🇿 | `flag_algeria`, `algeria` | Flag algeria |
| 🇪🇦 | `flag_ceuta_melilla`, `ceuta_melilla` | Flag ceuta & melilla |
| 🇪🇨 | `flag_ecuador`, `ecuador` | Flag ecuador |
| 🇪🇪 | `flag_estonia`, `estonia` | Flag estonia |
| 🇪🇬 | `flag_egypt`, `egypt` | Flag egypt |
| 🇪🇭 | `flag_western_sahara`, `western_sahara` | Flag western sahara |
| 🇪🇷 | `flag_eritrea`, `eritrea` | Flag eritrea |
| 🇪🇸 | `flag_spain`, `es` | Flag spain |
| 🇪🇹 | `flag_ethiopia`, `ethiopia` | Flag ethiopia |
| 🇪🇺 | `flag_european_union`, `eu`, `european_union` | Flag european union |
| 🇫🇮 | `flag_finland`, `finland` | Flag finland |
| 🇫🇯 | `flag_fiji`, `fiji` | Flag fiji |
| 🇫🇰 | `flag_falkland_islands`, `falkland_islands` | Flag falkland islands |
| 🇫🇲 | `flag_micronesia`, `micronesia` | Flag micronesia |
| 🇫🇴 | `flag_faroe_islands`, `faroe_islands` | Flag faroe islands |
| 🇫🇷 | `flag_france`, `fr` | Flag france |
| 🇬🇦 | `flag_gabon`, `gabon` | Flag gabon |
| 🇬🇧 | `flag_united_kingdom`, `gb`, `uk` | Flag united kingdom |
| 🇬🇩 | `flag_grenada`, `grenada` | Flag grenada |
| 🇬🇪 | `flag_georgia`, `georgia` | Flag georgia |
| 🇬🇫 | `flag_french_guiana`, `french_guiana` | Flag french guiana |
| 🇬🇬 | `flag_guernsey`, `guernsey` | Flag guernsey |
| 🇬🇭 | `flag_ghana`, `ghana` | Flag ghana |
| 🇬🇮 | `flag_gibraltar`, `gibraltar` | Flag gibraltar |
| 🇬🇱 | `flag_greenland`, `greenland` | Flag greenland |
| 🇬🇲 | `flag_gambia`, `gambia` | Flag gambia |
| 🇬🇳 | `flag_guinea`, `guinea` | Flag guinea |
| 🇬🇵 | `flag_guadeloupe`, `guadeloupe` | Flag guadeloupe |
| 🇬🇶 | `flag_equatorial_guinea`, `equatorial_guinea` | Flag equatorial guinea |
| 🇬🇷 | `flag_greece`, `greece` | Flag greece |
| 🇬🇸 | `flag_south_georgia_south_sandwich_islands`, `south_georgia_south_sandwich_islands` | Flag south georgia & south sandwich islands |
| 🇬🇹 | `flag_guatemala`, `guatemala` | Flag guatemala |
| 🇬🇺 | `flag_guam`, `guam` | Flag guam |
| 🇬🇼 | `flag_guinea_bissau`, `guinea_bissau` | Flag guinea-bissau |
| 🇬🇾 | `flag_guyana`, `guyana` | Flag guyana |
| 🇭🇰 | `flag_hong_kong_sar_china`, `hong_kong` | Flag hong kong sar china |
| 🇭🇲 | `flag_heard_mcdonald_islands`, `heard_mcdonald_islands` | Flag heard & mcdonald islands |
| 🇭🇳 | `flag_honduras`, `honduras` | Flag honduras |
| 🇭🇷 | `flag_croatia`, `croatia` | Flag croatia |
| 🇭🇹 | `flag_haiti`, `haiti` | Flag haiti |
| 🇭🇺 | `flag_hungary`, `hungary` | Flag hungary |
| 🇮🇨 | `flag_canary_islands`, `canary_islands` | Flag canary islands |
| 🇮🇩 | `flag_indonesia`, `indonesia` | Flag indonesia |
| 🇮🇪 | `flag_ireland`, `ireland` | Flag ireland |
| 🇮🇱 | `flag_israel`, `israel` | Flag israel |
| 🇮🇲 | `flag_isle_of_man`, `isle_of_man` | Flag isle of man |
| 🇮🇳 | `flag_india`, `india` | Flag india |
| 🇮🇴 | `flag_british_indian_ocean_territory`, `british_indian_ocean_territory` | Flag british indian ocean territory |
| 🇮🇶 | `flag_iraq`, `iraq` | Flag iraq |
| 🇮🇷 | `flag_iran`, `iran` | Flag iran |
| 🇮🇸 | `flag_iceland`, `iceland` | Flag iceland |
| 🇮🇹 | `flag_italy`, `it` | Flag italy |
| 🇯🇪 | `flag_jersey`, `jersey` | Flag jersey |
| 🇯🇲 | `flag_jamaica`, `jamaica` | Flag jamaica |
| 🇯🇴 | `flag_jordan`, `jordan` | Flag jordan |
| 🇯🇵 | `flag_japan`, `jp` | Flag japan |
| 🇰🇪 | `flag_kenya`, `kenya` | Flag kenya |
| 🇰🇬 | `flag_kyrgyzstan`, `kyrgyzstan` | Flag kyrgyzstan |
| 🇰🇭 | `flag_cambodia`, `cambodia` | Flag cambodia |
| 🇰🇮 | `flag_kiribati`, `kiribati` | Flag kiribati |
| 🇰🇲 | `flag_comoros`, `comoros` | Flag comoros |
| 🇰🇳 | `flag_st_kitts_nevis`, `st_kitts_nevis` | Flag st. kitts & nevis |
| 🇰🇵 | `flag_north_korea`, `north_korea` | Flag north korea |
| 🇰🇷 | `flag_south_korea`, `kr` | Flag south korea |
| 🇰🇼 | `flag_kuwait`, `kuwait` | Flag kuwait |
| 🇰🇾 | `flag_cayman_islands`, `cayman_islands` | Flag cayman islands |
| 🇰🇿 | `flag_kazakhstan`, `kazakhstan` | Flag kazakhstan |
| 🇱🇦 | `flag_laos`, `laos` | Flag laos |
| 🇱🇧 | `flag_lebanon`, `lebanon` | Flag lebanon |
| 🇱🇨 | `flag_st_lucia`, `st_lucia` | Flag st. lucia |
| 🇱🇮 | `flag_liechtenstein`, `liechtenstein` | Flag liechtenstein |
| 🇱🇰 | `flag_sri_lanka`, `sri_lanka` | Flag sri lanka |
| 🇱🇷 | `flag_liberia`, `liberia` | Flag liberia |
| 🇱🇸 | `flag_lesotho`, `lesotho` | Flag lesotho |
| 🇱🇹 | `flag_lithuania`, `lithuania` | Flag lithuania |
| 🇱🇺 | `flag_luxembourg`, `luxembourg` | Flag luxembourg |
| 🇱🇻 | `flag_latvia`, `latvia` | Flag latvia |
| 🇱🇾 | `flag_libya`, `libya` | Flag libya |
| 🇲🇦 | `flag_morocco`, `morocco` | Flag morocco |
| 🇲🇨 | `flag_monaco`, `monaco` | Flag monaco |
| 🇲🇩 | `flag_moldova`, `moldova` | Flag moldova |
| 🇲🇪 | `flag_montenegro`, `montenegro` | Flag montenegro |
| 🇲🇫 | `flag_st_martin`, `st_martin` | Flag st. martin |
| 🇲🇬 | `flag_madagascar`, `madagascar` | Flag madagascar |
| 🇲🇭 | `flag_marshall_islands`, `marshall_islands` | Flag marshall islands |
| 🇲🇰 | `flag_north_macedonia`, `macedonia` | Flag north macedonia |
| 🇲🇱 | `flag_mali`, `mali` | Flag mali |
| 🇲🇲 | `flag_myanmar`, `myanmar` | Flag myanmar (burma) |
| 🇲🇳 | `flag_mongolia`, `mongolia` | Flag mongolia |
| 🇲🇴 | `flag_macao_sar_china`, `macau` | Flag macao sar china |
| 🇲🇵 | `flag_northern_mariana_islands`, `northern_mariana_islands` | Flag northern mariana islands |
| 🇲🇶 | `flag_martinique`, `martinique` | Flag martinique |
| 🇲🇷 | `flag_mauritania`, `mauritania` | Flag mauritania |
| 🇲🇸 | `flag_montserrat`, `montserrat` | Flag montserrat |
| 🇲🇹 | `flag_malta`, `malta` | Flag malta |
| 🇲🇺 | `flag_mauritius`, `mauritius` | Flag mauritius |
| 🇲🇻 | `flag_maldives`, `maldives` | Flag maldives |
| 🇲🇼 | `flag_malawi`, `malawi` | Flag malawi |
| 🇲🇽 | `flag_mexico`, `mexico` | Flag mexico |
| 🇲🇾 | `flag_malaysia`, `malaysia` | Flag malaysia |
| 🇲🇿 | `flag_mozambique`, `mozambique` | Flag mozambique |
| 🇳🇦 | `flag_namibia`, `namibia` | Flag namibia |
| 🇳🇨 | `flag_new_caledonia`, `new_caledonia` | Flag new caledonia |
| 🇳🇪 | `flag_niger`, `niger` | Flag niger |
| 🇳🇫 | `flag_norfolk_island`, `norfolk_island` | Flag norfolk island |
| 🇳🇬 | `flag_nigeria`, `nigeria` | Flag nigeria |
| 🇳🇮 | `flag_nicaragua`, `nicaragua` | Flag nicaragua |
| 🇳🇱 | `flag_netherlands`, `netherlands` | Flag netherlands |
| 🇳🇴 | `flag_norway`, `norway` | Flag norway |
| 🇳🇵 | `flag_nepal`, `nepal` | Flag nepal |
| 🇳🇷 | `flag_nauru`, `nauru` | Flag nauru |
| 🇳🇺 | `flag_niue`, `niue` | Flag niue |
| 🇳🇿 | `flag_new_zealand`, `new_zealand` | Flag new zealand |
| 🇴🇲 | `flag_oman`, `oman` | Flag oman |
| 🇵🇦 | `flag_panama`, `panama` | Flag panama |
| 🇵🇪 | `flag_peru`, `peru` | Flag peru |
| 🇵🇫 | `flag_french_polynesia`, `french_polynesia` | Flag french polynesia |
| 🇵🇬 | `flag_papua_new_guinea`, `papua_new_guinea` | Flag papua new guinea |
| 🇵🇭 | `flag_philippines`, `philippines` | Flag philippines |
| 🇵🇰 | `flag_pakistan`, `pakistan` | Flag pakistan |
| 🇵🇱 | `flag_poland`, `poland` | Flag poland |
| 🇵🇲 | `flag_st_pierre_miquelon`, `st_pierre_miquelon` | Flag st. pierre & miquelon |
| 🇵🇳 | `flag_pitcairn_islands`, `pitcairn_islands` | Flag pitcairn islands |
| 🇵🇷 | `flag_puerto_rico`, `puerto_rico` | Flag puerto rico |
| 🇵🇸 | `flag_palestinian_territories`, `palestinian_territories` | Flag palestinian territories |
| 🇵🇹 | `flag_portugal`, `portugal` | Flag portugal |
| 🇵🇼 | `flag_palau`, `palau` | Flag palau |
| 🇵🇾 | `flag_paraguay`, `paraguay` | Flag paraguay |
| 🇶🇦 | `flag_qatar`, `qatar` | Flag qatar |
| 🇷🇪 | `flag_reunion`, `reunion` | Flag réunion |
| 🇷🇴 | `flag_romania`, `romania` | Flag romania |
| 🇷🇸 | `flag_serbia`, `serbia` | Flag serbia |
| 🇷🇺 | `flag_russia`, `ru` | Flag russia |
| 🇷🇼 | `flag_rwanda`, `rwanda` | Flag rwanda |
| 🇸🇦 | `flag_saudi_arabia`, `saudi_arabia` | Flag saudi arabia |
| 🇸🇧 | `flag_solomon_islands`, `solomon_islands` | Flag solomon islands |
| 🇸🇨 | `flag_seychelles`, `seychelles` | Flag seychelles |
| 🇸🇩 | `flag_sudan`, `sudan` | Flag sudan |
| 🇸🇪 | `flag_sweden`, `sweden` | Flag sweden |
| 🇸🇬 | `flag_singapore`, `singapore` | Flag singapore |
| 🇸🇭 | `flag_st_helena`, `st_helena` | Flag st. helena |
| 🇸🇮 | `flag_slovenia`, `slovenia` | Flag slovenia |
| 🇸🇯 | `flag_svalbard_jan_mayen`, `svalbard_jan_mayen` | Flag svalbard & jan mayen |
| 🇸🇰 | `flag_slovakia`, `slovakia` | Flag slovakia |
| 🇸🇱 | `flag_sierra_leone`, `sierra_leone` | Flag sierra leone |
| 🇸🇲 | `flag_san_marino`, `san_marino` | Flag san marino |
| 🇸🇳 | `flag_senegal`, `senegal` | Flag senegal |
| 🇸🇴 | `flag_somalia`, `somalia` | Flag somalia |
| 🇸🇷 | `flag_suriname`, `suriname` | Flag suriname |
| 🇸🇸 | `flag_south_sudan`, `south_sudan` | Flag south sudan |
| 🇸🇹 | `flag_sao_tome_principe`, `sao_tome_principe` | Flag são tomé & príncipe |
| 🇸🇻 | `flag_el_salvador`, `el_salvador` | Flag el salvador |
| 🇸🇽 | `flag_sint_maarten`, `sint_maarten` | Flag sint maarten |
| 🇸🇾 | `flag_syria`, `syria` | Flag syria |
| 🇸🇿 | `flag_eswatini`, `swaziland` | Flag eswatini |
| 🇹🇦 | `flag_tristan_da_cunha`, `tristan_da_cunha` | Flag tristan da cunha |
| 🇹🇨 | `flag_turks_caicos_islands`, `turks_caicos_islands` | Flag turks & caicos islands |
| 🇹🇩 | `flag_chad`, `chad` | Flag chad |
| 🇹🇫 | `flag_french_southern_territories`, `french_southern_territories` | Flag french southern territories |
| 🇹🇬 | `flag_togo`, `togo` | Flag togo |
| 🇹🇭 | `flag_thailand`, `thailand` | Flag thailand |
| 🇹🇯 | `flag_tajikistan`, `tajikistan` | Flag tajikistan |
| 🇹🇰 | `flag_tokelau`, `tokelau` | Flag tokelau |
| 🇹🇱 | `flag_timor_leste`, `timor_leste` | Flag timor-leste |
| 🇹🇲 | `flag_turkmenistan`, `turkmenistan` | Flag turkmenistan |
| 🇹🇳 | `flag_tunisia`, `tunisia` | Flag tunisia |
| 🇹🇴 | `flag_tonga`, `tonga` | Flag tonga |
| 🇹🇷 | `flag_turkey`, `tr` | Flag turkey |
| 🇹🇹 | `flag_trinidad_tobago`, `trinidad_tobago` | Flag trinidad & tobago |
| 🇹🇻 | `flag_tuvalu`, `tuvalu` | Flag tuvalu |
| 🇹🇼 | `flag_taiwan`, `taiwan` | Flag taiwan |
| 🇹🇿 | `flag_tanzania`, `tanzania` | Flag tanzania |
| 🇺🇦 | `flag_ukraine`, `ukraine` | Flag ukraine |
| 🇺🇬 | `flag_uganda`, `uganda` | Flag uganda |
| 🇺🇲 | `flag_u_s_outlying_islands`, `us_outlying_islands` | Flag u.s. outlying islands |
| 🇺🇳 | `flag_united_nations`, `united_nations` | Flag united nations |
| 🇺🇸 | `flag_united_states`, `us` | Flag united states |
| 🇺🇾 | `flag_uruguay`, `uruguay` | Flag uruguay |
| 🇺🇿 | `flag_uzbekistan`, `uzbekistan` | Flag uzbekistan |
| 🇻🇦 | `flag_vatican_city`, `vatican_city` | Flag vatican city |
| 🇻🇨 | `flag_st_vincent_grenadines`, `st_vincent_grenadines` | Flag st. vincent & grenadines |
| 🇻🇪 | `flag_venezuela`, `venezuela` | Flag venezuela |
| 🇻🇬 | `flag_british_virgin_islands`, `british_virgin_islands` | Flag british virgin islands |
| 🇻🇮 | `flag_u_s_virgin_islands`, `us_virgin_islands` | Flag u.s. virgin islands |
| 🇻🇳 | `flag_vietnam`, `vietnam` | Flag vietnam |
| 🇻🇺 | `flag_vanuatu`, `vanuatu` | Flag vanuatu |
| 🇼🇫 | `flag_wallis_futuna`, `wallis_futuna` | Flag wallis & futuna |
| 🇼🇸 | `flag_samoa`, `samoa` | Flag samoa |
| 🇽🇰 | `flag_kosovo`, `kosovo` | Flag kosovo |
| 🇾🇪 | `flag_yemen`, `yemen` | Flag yemen |
| 🇾🇹 | `flag_mayotte`, `mayotte` | Flag mayotte |
| 🇿🇦 | `flag_south_africa`, `south_africa` | Flag south africa |
| 🇿🇲 | `flag_zambia`, `zambia` | Flag zambia |
| 🇿🇼 | `flag_zimbabwe`, `zimbabwe` | Flag zimbabwe |
| 🏴󠁧󠁢󠁥󠁮󠁧󠁿 | `flag_england`, `england` | Flag england |
| 🏴󠁧󠁢󠁳󠁣󠁴󠁿 | `flag_scotland`, `scotland` | Flag scotland |
| 🏴󠁧󠁢󠁷󠁬󠁳󠁿 | `flag_wales`, `wales` | Flag wales |
| 🇦 | `regional_indicator_a`, `A` | Regional Indicator A |
| 🇧 | `regional_indicator_b`, `B` | Regional Indicator B |
| 🇨 | `regional_indicator_c`, `C` | Regional Indicator C |
| 🇩 | `regional_indicator_d`, `D` | Regional Indicator D |
| 🇪 | `regional_indicator_e`, `E` | Regional Indicator E |
| 🇫 | `regional_indicator_f`, `F` | Regional Indicator F |
| 🇬 | `regional_indicator_g`, `G` | Regional Indicator G |
| 🇭 | `regional_indicator_h`, `H` | Regional Indicator H |
| 🇮 | `regional_indicator_i`, `I` | Regional Indicator I |
| 🇯 | `regional_indicator_j`, `J` | Regional Indicator J |
| 🇰 | `regional_indicator_k`, `K` | Regional Indicator K |
| 🇱 | `regional_indicator_l`, `L` | Regional Indicator L |
| 🇲 | `regional_indicator_m`, `M` | Regional Indicator M |
| 🇳 | `regional_indicator_n`, `N` | Regional Indicator N |
| 🇴 | `regional_indicator_o`, `O` | Regional Indicator O |
| 🇵 | `regional_indicator_p`, `P` | Regional Indicator P |
| 🇶 | `regional_indicator_q`, `Q` | Regional Indicator Q |
| 🇷 | `regional_indicator_r`, `R` | Regional Indicator R |
| 🇸 | `regional_indicator_s`, `S` | Regional Indicator S |
| 🇹 | `regional_indicator_t`, `T` | Regional Indicator T |
| 🇺 | `regional_indicator_u`, `U` | Regional Indicator U |
| 🇻 | `regional_indicator_v`, `V` | Regional Indicator V |
| 🇼 | `regional_indicator_w`, `W` | Regional Indicator W |
| 🇽 | `regional_indicator_x`, `X` | Regional Indicator X |
| 🇾 | `regional_indicator_y`, `Y` | Regional Indicator Y |
| 🇿 | `regional_indicator_z`, `Z` | Regional Indicator Z |
