...
| 🇦 | `A`, `regional_indicator_a` | Regional Indicator A |
| 🇧 | `B`, `regional_indicator_b` | Regional Indicator B |
| 🇨 | `C`, `regional_indicator_c` | Regional Indicator C |
| 🇩 | `D`, `regional_indicator_d` | Regional Indicator D |
| 🇪 | `E`, `regional_indicator_e` | Regional Indicator E |
| 🇫 | `F`, `regional_indicator_f` | Regional Indicator F |
| 🇬 | `G`, `regional_indicator_g` | Regional Indicator G |
| 🇭 | `H`, `regional_indicator_h` | Regional Indicator H |
| 🇮 | `I`, `regional_indicator_i` | Regional Indicator I |
| 🇯 | `J`, `regional_indicator_j` | Regional Indicator J |
| 🇰 | `K`, `regional_indicator_k` | Regional Indicator K |
| 🇱 | `L`, `regional_indicator_l` | Regional Indicator L |
| 🇲 | `M`, `regional_indicator_m` | Regional Indicator M |
| 🇳 | `N`, `regional_indicator_n` | Regional Indicator N |
| 🇴 | `O`, `regional_indicator_o` | Regional Indicator O |
| 🇵 | `P`, `regional_indicator_p` | Regional Indicator P |
| 🇶 | `Q`, `regional_indicator_q` | Regional Indicator Q |
| 🇷 | `R`, `regional_indicator_r` | Regional Indicator R |
| 🇸 | `S`, `regional_indicator_s` | Regional Indicator S |
| 🇹 | `T`, `regional_indicator_t` | Regional Indicator T |
| 🇺 | `U`, `regional_indicator_u` | Regional Indicator U |
| 🇻 | `V`, `regional_indicator_v` | Regional Indicator V |
